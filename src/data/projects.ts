...
export const projects: Project[] = [
  {
    ...
    description: "CineSnap is a full-featured movie booking platform that simplifies ticket purchases while providing real-time updates and a seamless user experience.",
    technologies: ["Angular", "TypeScript", "MongoDB", "Node", "Express", "AWS", "Github Actions", "Docker"],
    features: [
  ...
  },
  {
    ...
    logo: "/api/placeholder/300/200",
    description: "Gents Garage is a modern e-commerce platform for men's accessories, designed to offer smooth browsing, reliable payments, and efficient order management.",
  ...
  },
  {
    ...
    logo: "/api/placeholder/300/200",
    description: "Passerby is a peer-to-peer real-time video chat application that enables seamless communication with dynamic room management and low-latency connections.",
    technologies: ["Node", "Socket.io", "WebRTC", "React", "TypeScript", "Redis"],
    features: [
  ...
  },
  {
    ...
    logo: "/api/placeholder/300/200",
    description: "Trace53 is a custom DNS server built for accuracy, speed, and robust handling of complex domain queries.",
  ...
  },
  {
    ...
    logo: "/api/placeholder/300/200",
    description: "A sample microservices backend demonstrating scalable, modular architecture with event-driven communication and centralized logging for social media applications.",
